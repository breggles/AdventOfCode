...
(defonce input-day5-stacks "    [G] [R]                 [P]    
    [H] [W]     [T] [P]     [H]    
    [F] [T] [P] [B] [D]     [N]    
[L] [T] [M] [Q] [L] [C]     [Z]    
[C] [C] [N] [V] [S] [H]     [V] [G]
...
(defonce input-day5-moves "move 5 from 8 to 2
move 2 from 4 to 5
move 3 from 3 to 9
move 4 from 1 to 8
move 5 from 9 to 1
...
(defonce input-day6 "")
...
(defonce input-day8 "020111211022103023211142403044034010412103202221251542233334311102303044440313120021223120332211221
...
(defonce input-day9-parti-test "R 4
U 4
L 3
D 1
R 4
...
(defonce input-day9-partii-test "R 5
U 8
L 8
D 3
R 17
...
(defonce input-day10-test "addx 15
addx -11
addx 6
addx -3
addx 5
...
(defonce input-day11-test "Monkey 0:
